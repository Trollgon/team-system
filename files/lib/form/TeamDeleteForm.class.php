...
class TeamDeleteForm extends AbstractForm {
	...
	public function save() {
		parent::save();
			...
			switch ($this->platformID) {
				case 1:
					$action = new PcTeamAction(array($this->teamID), 'delete');
					...
					break;
				case 2:
					$action = new Ps4TeamAction(array($this->teamID), 'delete');
					$action->executeAction();
					$userdata = array(
							'data' => array(
					...
					break;
				case 3:
					$action = new Ps3TeamAction(array($this->teamID), 'delete');
					$action->executeAction();
					$userdata = array(
							'data' => array(
					...
					break;
				case 4:
					$action = new Xb1TeamAction(array($this->teamID), 'delete');
					$action->executeAction();
					$userdata = array(
							'data' => array(
					...
					break;
				case 5:
					$action = new Xb360TeamAction(array($this->teamID), 'delete');
					$action->executeAction();
					$userdata = array(
							'data' => array(
