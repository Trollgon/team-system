...
<script data-relocate="true">
    $(function () {
        new WCF.Action.Delete('teamsystem\\data\\platform\\PlatformAction', '.jsPlatformRow');
    });
</script>
...
<header class="contentHeader">
    ...
    <nav class="contentHeaderNavigation">
        <ul>
            <li><a href="{link application='teamsystem' controller='PlatformAdd'}{/link}" class="button"><span
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th class="columnText columnClassName">
                    {lang}teamsystem.acp.platform.title{/lang}
                </th>
                ...
                <tr class="jsPlatformRow">
                    <td class="columnIcon">
                        {* toggle, edit, delete *}
                            ...
                            <span class="icon icon16 fa-times jsDeleteButton jsTooltip pointer" title="{lang}wcf.global.button.delete{/lang}" data-object-id="{@$platform->platformID}" data-confirm-message-html="{lang __encode=true}teamsystem.acp.platform.save{/lang}"></span>
                        {event name='buttons'}
                    </td>
...
{else}
    <p class="info">{lang}teamsystem.acp.platform.noContent{/lang}</p>
{/if}
